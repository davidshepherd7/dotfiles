...
key.setGlobalKey([['M-x'], ['<menu>']], function (ev, arg) {
    ext.select(arg, ev);
...
key.setGlobalKey(['C-\\', 'C-s'], function (ev) {
...
key.setGlobalKey('undefined', function (ev) {
...
key.setEditKey(['C-\\', 'r', 'd'], function (ev, arg) {
    command.replaceRectangle(ev.originalTarget, "", false, !arg);
}, 'Delete text in the region-rectangle', true);

key.setEditKey(['C-\\', 'r', 't'], function (ev) {
...
key.setEditKey([['C-<backspace>'], ['M-<delete>'], ['C-y']], function (ev) {
...
key.setEditKey('C-X', function (ev) {
    command.killLine(ev);
...
key.setCaretKey(['C-\\', 'h'], function (ev) {
    goDoCommand("cmd_selectAll");
}, 'Select all', true);
