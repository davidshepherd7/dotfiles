...
(setq ds/python-stdlib '("abc" "anydbm" "argparse" "array" "asynchat" "asyncore" "atexit" "base64"
                         ...
                         "xmlrpclib" "zipfile" "zipimport" "zlib" "builtins" "__builtin__" "collections.abc"))
...
(defun ds/vscode ()
  ...
  (start-process "code" nil "code"
                 "--goto" (s-concat (buffer-file-name) ":" (number-to-string (line-number-at-pos nil 'absolute)))
                 "--reuse-window")
  )
