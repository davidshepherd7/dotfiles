...
# Redefine ssh autocompletion to use a cache of hosts to speed it up enormously
# for large numbers of hosts (e.g. as generated by GCP). Requires running
# refresh_ssh_autocomplete after a new host is added.
